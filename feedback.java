...
public class feedback extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t1=(EditText)findViewById(R.id.textView32);
    ...
    public void onClick(View view) {
        ...
        String url = "http://" + hu + ":5000/feedback_post";
...
//                                    ed.commit();
                                ...
                                Intent ii = new Intent(getApplicationContext(), userviewproductrequest.class);
                                startActivity(ii);
...
//                                    startActivity(i);
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("prid", hu);
                params.put("lid", li);
                params.put("feedback", t1.getText().toString());
